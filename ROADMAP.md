...
| --- | --- | --- |
| Delivery pending | Build/version visibility | [#113](https://github.com/flotilla-org/cleat/issues/113): implemented and tested locally in `a510f8c`; needs PR delivery. GitHub main was `15f216c` at this audit. Keep the issue open until merged. |
